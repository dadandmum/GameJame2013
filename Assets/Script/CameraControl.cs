...
public class CameraControl : MonoBehaviour {
	...
	void SetPosition(){
		Vector3 tem_pos = Camera.main.transform.position ;
		Vector3 player_pos = PlayerControl.player.transform.position;
		Vector3 pos = new Vector3( player_pos.x , player_pos.y , ( tem_pos.z * ( 1- PositionRelate ) + wanted_position.z * PositionRelate ) );
